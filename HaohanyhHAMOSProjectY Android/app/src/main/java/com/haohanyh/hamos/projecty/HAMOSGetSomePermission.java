...
public class HAMOSGetSomePermission {
    ...
    private HAMOSGetSomePermission(@NonNull Object object) {
        mObject = object;
    }

    public static HAMOSGetSomePermission with(@NonNull Activity activity) {
        return new HAMOSGetSomePermission(activity);
    }

    public HAMOSGetSomePermission permissions(@NonNull String... permissions) {
        mPermissions = permissions;
        return this;
    }

    public HAMOSGetSomePermission requestCode(int requestCode) {
        mRequestCode = requestCode;
        return this;
    }

    public HAMOSGetSomePermission request() {
